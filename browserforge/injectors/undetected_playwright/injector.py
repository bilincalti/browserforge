...
from undetected_patchright.async_api import Browser as AsyncBrowser
from undetected_patchright.async_api import BrowserContext as AsyncBrowserContext
from undetected_patchright.sync_api import Browser, BrowserContext
...
async def AsyncNewContext(
    ...
    **context_options,
    ...
    """
    Injects an async_api Undetected-patchright context with a Fingerprint.
...
def NewContext(
    ...
    **context_options,
    ...
    """
    Injects a sync_api Undetected-patchright context with a Fingerprint.
